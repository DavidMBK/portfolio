  ...
  <div className='relative h-dvh w-screen overflow-x-hidden'>
    <div id='video-frame' className='relative z-10 h-dvh w-screen overflow-x-hidden rounded-lg bg-blue-75'> 
      <div>
        ...
        muted
        id="next-video"
        className='absolute-center invisible absolute z-20 size-64 obejct-cover object-center obejct-center'
        onLoadedData={handleVideoLoad} 
      ...
      <h1 className='font-special hero-heading absolute bottom-5 right-5 z-40 text-blue-75'>
      G<b>a</b>ming
      </h1>
